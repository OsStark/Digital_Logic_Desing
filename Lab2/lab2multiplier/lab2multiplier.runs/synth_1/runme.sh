...
HD_PWD='C:/Users/user/lab2multiplier/lab2multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbitmultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourbitmultiplier.tcl
