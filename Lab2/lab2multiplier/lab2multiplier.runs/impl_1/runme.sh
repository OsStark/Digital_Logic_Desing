...
HD_PWD='C:/Users/user/lab2multiplier/lab2multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbitmultiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourbitmultiplier.tcl -notrace
