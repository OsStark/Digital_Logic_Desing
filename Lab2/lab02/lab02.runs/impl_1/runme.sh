...
HD_PWD='C:/Users/user/lab02/lab02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbit_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourbit_adder.tcl -notrace
