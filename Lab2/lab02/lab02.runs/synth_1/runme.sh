...
HD_PWD='C:/Users/user/lab02/lab02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbit_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourbit_adder.tcl
